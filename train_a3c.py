...
from network import ActorCriticNoTargetNetwork
from training_thread_a3c import A3CTrainingThread
...
if __name__ == '__main__':
  ...
  global_network = ActorCriticNoTargetNetwork(action_size = ACTION_SIZE,
                                        device = device,
  ...
  training_threads = []
  for i in range(A3C_THREAD_SIZE):
  ...
  def train_function(parallel_index):
    ...
    scene, task = branches[0]
    key = scene + "-" + task# + "-" + str(parallel_index)
